      ...
      <v-col cols="12">
        ...
        <v-card-text class="pt-4">
          <v-row>
            ...
            <v-col cols="6">
              <v-text-field
                label="Capture Spec Name"
                v-model="addSpecObject.displayname"
                required
              ></v-text-field>
            </v-col>
            <v-col cols="6">
            ...
            <v-col cols="6">
              <v-text-field
                type="number"
                label="Delay before screenshot (ms)"
                v-model="addSpecObject.delay"
                required
              ></v-text-field>
            </v-col>
            <v-col cols="12">
